    ...
    managedServices: [
      {
        ...
        description: t({
          en: "A&M الدولية delivers tailored Enterprise Performance Management solutions that seamlessly align business processes with modern technology improving financial performance, operational accuracy, and long-term strategic success.",
      ...
      },
      {
        ...
        description: t({
          en: "A&M الدولية enhances Enterprise Performance Management systems by optimizing workflows, strengthening financial efficiency, and enabling data-driven decision-making through customized, insight-focused strategies.",
      ...
      },
      {
        ...
        description: t({
          en: "A&M الدولية ensures seamless version upgrades, patching, and stability improvements for Enterprise Performance Management platforms minimizing operational disruption, improving reliability, and maximizing overall system performance.",
      ...
      },
      {
        ...
        description: t({
          en: "A&M الدولية provides comprehensive Managed Services for ongoing EPM maintenance and administration. Our team manages data loads, reporting cycles, consolidations, and other critical monthly processes ensuring every task is completed accurately, consistently, and on schedule.",
