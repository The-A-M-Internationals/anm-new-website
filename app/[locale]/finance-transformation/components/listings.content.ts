    ...
    managedServices: [
      {
        ...
        description: t({
          ...
          ar: "تقدم A&M International حلولًا مخصصة لإدارة أداء المؤسسات تُوائم عمليات الأعمال مع التقنية الحديثة لتحسين الأداء المالي ودقة التشغيل والنجاح الاستراتيجي على المدى الطويل.",
        }),
        tags: [
          t({
      ...
      },
      {
        ...
        description: t({
          ...
          ar: "تعزز A&M International أنظمة إدارة أداء المؤسسات عبر تحسين سير العمل ورفع الكفاءة المالية وتمكين اتخاذ القرار القائم على البيانات من خلال استراتيجيات مخصصة تركز على الرؤى.",
        }),
        tags: [
      ...
      },
      {
        ...
        description: t({
          ...
          ar: "تضمن A&M International ترقية الإصدارات والتحديثات وتحسين الاستقرار لمنصات إدارة أداء المؤسسات مع تقليل تعطل التشغيل وتحسين الاعتمادية وتعظيم أداء النظام.",
        }),
        tags: [
          t({
      ...
      },
      {
        ...
        description: t({
          ...
          ar: "تقدم A&M International خدمات مُدارة شاملة لصيانة وإدارة حلول EPM بشكل مستمر. يدير فريقنا تحميل البيانات ودورات التقارير والتوحيدات وغيرها من العمليات الشهرية الحرجة لضمان إنجاز كل مهمة بدقة وبشكل متسق وفي الوقت المحدد.",
        }),
        tags: [
          t({
