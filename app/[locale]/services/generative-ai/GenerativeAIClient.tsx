...
const GenerativeAIHero = () => {
    ...
    return (
        <>
            ...
            <section className="relative overflow-hidden bg-gradient-to-br from-[#050A1E] via-[#0A1628] to-[#08111A] min-h-screen flex items-center">
                <canvas ref={canvasRef} className="absolute inset-0 pointer-events-none" style={{ opacity: 0.6 }} />

                <div 
                    className="absolute inset-0 opacity-20"
                    style={{
                        backgroundImage: 'radial-gradient(circle at 80% 20%, rgba(96, 165, 250, 0.2) 0%, transparent 50%)',
                ...
                >
                    <div className="inline-flex items-center gap-3 px-6 py-3 mb-10 rounded-full bg-white/5 border border-[#60A5FA]/20 backdrop-blur-xl relative overflow-hidden">
                        ...
                        <span className="relative text-[#60A5FA] text-sm font-semibold tracking-wide">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 sm:gap-12 max-w-4xl mx-auto">
                        {[
                            ...
                            <div key={i} className="group relative">
                                <div className="text-4xl sm:text-5xl md:text-6xl font-bold bg-gradient-to-br from-[#60A5FA] to-[#93C5FD] bg-clip-text text-transparent mb-3 transition-transform duration-300 group-hover:scale-110">
                                    {stat.value}
                                </div>
                ...
                <div className="absolute bottom-12 left-1/2 -translate-x-1/2">
                    <div className="flex flex-col items-center gap-3 animate-bounce">
                        <span className="text-[#60A5FA]/50 text-xs uppercase tracking-widest font-light">
...
const GenAIServices = () => {
    ...
    return (
        <section id="gen-ai-services" className="py-24 bg-gradient-to-b from-[#08111A] to-[#050A1E]">
