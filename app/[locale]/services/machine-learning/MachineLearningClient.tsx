...
const MachineLearningHero = () => {
    ...
    const content = useIntlayer("machineLearningPage");
        ...
        <>
            ...
            <section className="relative overflow-hidden bg-gradient-to-br from-[#050A1E] via-[#0A1628] to-[#08111A] min-h-screen flex items-center">
                ...
                <div 
                    ...
                    style={{
                        backgroundImage: 'radial-gradient(circle at 20% 30%, rgba(37, 99, 235, 0.2) 0%, transparent 50%)',
                ...
                >
                    <div className="inline-flex items-center gap-3 px-6 py-3 mb-10 rounded-full bg-white/5 border border-[#2563EB]/20 backdrop-blur-xl relative overflow-hidden">
                        ...
                        <span className="relative text-[#2563EB] text-sm font-semibold tracking-wide">
                    ...
                    <h1 className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-bold text-white mb-8 leading-tight" style={{ fontFamily: "var(--heading-font)" }}>
                        ...
                        <span className="relative inline-block mt-4">
                            <span 
                                className="bg-gradient-to-r from-[#2563EB] via-[#60A5FA] to-[#2563EB] bg-clip-text text-transparent"
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 sm:gap-12 max-w-4xl mx-auto">
                        {[
                            ...
                            <div key={i} className="group relative">
                                <div className="text-4xl sm:text-5xl md:text-6xl font-bold bg-gradient-to-br from-[#2563EB] to-[#60A5FA] bg-clip-text text-transparent mb-3 transition-transform duration-300 group-hover:scale-110">
                                    {stat.value}
                                </div>
                ...
                <div className="absolute bottom-12 left-1/2 -translate-x-1/2">
                    <div className="flex flex-col items-center gap-3 animate-bounce">
                        <span className="text-[#2563EB]/50 text-xs uppercase tracking-widest font-light">
                    ...
                    {services.map((service, index) => (
                        ...
                        >
                            ...
                            <div className="relative">
                                <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[#2563EB]/20 to-[#60A5FA]/10 flex items-center justify-center mb-6">
