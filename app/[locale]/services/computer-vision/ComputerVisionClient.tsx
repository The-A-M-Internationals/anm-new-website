...
const ComputerVisionHero = () => {
    ...
    const content = useIntlayer("computerVisionPage");
    ...
    return (
        <>
            ...
            <section className="relative overflow-hidden bg-gradient-to-br from-[#050A1E] via-[#0C1F4A] to-[#0A1628] min-h-screen flex items-center">
                ...
                >
                    <div className="inline-flex items-center gap-3 px-6 py-3 mb-10 rounded-full bg-white/5 border border-[#0EA5E9]/20 backdrop-blur-xl relative overflow-hidden">
                        ...
                        <span className="relative text-[#0EA5E9] text-sm font-semibold tracking-wide">
                    ...
                    <h1 className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-bold text-white mb-8 leading-tight" style={{ fontFamily: "var(--heading-font)" }}>
                        ...
                        <span className="relative inline-block mt-4">
                            <span 
                                className="bg-gradient-to-r from-[#0EA5E9] via-[#38BDF8] to-[#0EA5E9] bg-clip-text text-transparent"
                    ...
                    <div className="flex flex-col sm:flex-row gap-6 justify-center mb-20">
                        ...
                        >
                            <div className="absolute inset-0 bg-gradient-to-r from-[#38BDF8] to-[#0EA5E9] opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                        ...
                        <button
                            onClick={(e) => {
                                if (!handleHashLink(e, "#cv-services", router)) {
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 sm:gap-12 max-w-4xl mx-auto">
                        {[
                            ...
                            <div key={i} className="group relative">
                                <div className="text-4xl sm:text-5xl md:text-6xl font-bold bg-gradient-to-br from-[#0EA5E9] to-[#38BDF8] bg-clip-text text-transparent mb-3 transition-transform duration-300 group-hover:scale-110">
                                    {stat.value}
                                </div>
                ...
                <div className="absolute bottom-12 left-1/2 -translate-x-1/2">
                    <div className="flex flex-col items-center gap-3 animate-bounce">
                        <span className="text-[#0EA5E9]/50 text-xs uppercase tracking-widest font-light">
                    ...
                    {services.map((service, index) => (
                        ...
                        >
                            ...
                            <div className="relative">
                                <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[#0EA5E9]/20 to-[#38BDF8]/10 flex items-center justify-center mb-6">
