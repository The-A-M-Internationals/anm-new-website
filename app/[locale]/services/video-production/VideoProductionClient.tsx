...
const VideoProductionHero = () => {
    ...
    const content = useIntlayer("videoProductionPage");
        ...
        <>
            ...
            <section className="relative overflow-hidden bg-gradient-to-br from-[#050A1E] via-[#0C1F4A] to-[#08111A] min-h-screen flex items-center">
                ...
                <div 
                    ...
                    style={{
                        backgroundImage: 'radial-gradient(circle at 70% 30%, rgba(201, 168, 76, 0.15) 0%, transparent 50%)',
                ...
                >
                    <div className="inline-flex items-center gap-3 px-6 py-3 mb-10 rounded-full bg-white/5 border border-[#C9A84C]/20 backdrop-blur-xl relative overflow-hidden">
                        ...
                        <span className="relative text-[#C9A84C] text-sm font-semibold tracking-wide uppercase">
                    ...
                    <h1 className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-bold text-white mb-8 leading-tight" style={{ fontFamily: "var(--heading-font)" }}>
                        ...
                        <span className="relative inline-block mt-4">
                            <span 
                                className="bg-gradient-to-r from-[#C9A84C] via-[#E5C17C] to-[#C9A84C] bg-clip-text text-transparent"
                ...
                <div className="absolute bottom-12 left-1/2 -translate-x-1/2">
                    <div className="flex flex-col items-center gap-3 animate-bounce">
                        <span className="text-[#C9A84C]/50 text-xs uppercase tracking-widest font-light">
                    ...
                    {services.map((service, index) => (
                        ...
                        >
                            ...
                            <div className="relative">
                                <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[#C9A84C]/20 to-[#E5C17C]/10 flex items-center justify-center mb-6">
