...
const LeadershipTeam = () => {
    ...
    return (
        <div id="team" className='flex flex-col items-center justify-center px-4 py-8 mb-10'>
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-10 mt-12 flex-wrap w-full items-center">
                {Services.map((service, idx) => (
                    <div
                        key={idx}
                        className="relative w-full max-w-[370px] h-[450px] sm:h-[500px] rounded-2xl overflow-visible"
                    ...
                    >
                        ...
                        {/* HOVER POPUP - Left for first, Right for second */}
                        {hoveredIndex === idx && (
                            <div
