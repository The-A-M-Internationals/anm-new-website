...
const leadershipTeamContent: Dictionary = {
  ...
  content: {
    ...
    leader1RoleLine: {
      nodeType: "translation",
      translation: {
        [Locales.ENGLISH]: "CEO & Co-Founder, A&M International",
        [Locales.ARABIC]: "الرئيس التنفيذي والشريك المؤسس، A&M International",
      },
    },
    leader1FullBio: {
      nodeType: "translation",
      translation: {
        [Locales.ENGLISH]: "An ambitious leader in financial transformation and performance-driven innovation, Anusha Anala leads A&M International's mission to help global organizations work smarter and scale faster. With over 15 years of experience in enterprise performance, analytics, and modern finance operations, she turns complexity into clarity—delivering streamlined processes, scalable solutions, and measurable business results. Anusha leads with strategic precision, innovation, and an unwavering commitment to client success.",
...
export default leadershipTeamContent;
