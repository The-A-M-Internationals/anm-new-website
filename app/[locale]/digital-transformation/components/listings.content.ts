    ...
    managedServices: [
      {
        ...
        description: t({
          en: "A&M Internationals provides end-to-end programme management for complex digital transformation initiatives, ensuring on-time delivery, stakeholder alignment, and measurable business outcomes.",
          ar: "تقدم A&M Internationals إدارة برامج شاملة لمبادرات التحول الرقمي المعقدة، مع ضمان التسليم في الوقت المحدد وتوافق أصحاب المصلحة وتحقيق نتائج أعمال قابلة للقياس.",
        }),
        tags: [
      ...
      },
      {
        ...
        description: t({
          en: "A&M Internationals manages your cloud environment on an ongoing basis — monitoring performance, controlling costs, applying patches, and ensuring availability so your teams can focus on business outcomes.",
          ar: "تدير A&M Internationals بيئتك السحابية باستمرار — مراقبة الأداء والتحكم في التكاليف وتطبيق التحديثات وضمان التوفر حتى تتمكن فرقك من التركيز على نتائج الأعمال.",
        }),
        tags: [
      ...
      },
      {
        ...
        description: t({
          en: "A&M Internationals provides ongoing support and continuous enhancement for business-critical applications, managing incidents, releases, and improvements to keep your systems performing at their best.",
          ar: "تقدم A&M Internationals دعمًا مستمرًا وتحسينات متواصلة للتطبيقات الحيوية للأعمال، وإدارة الحوادث والإصدارات والتحسينات للحفاظ على أداء أنظمتك بأفضل مستوى.",
        }),
        tags: [
      ...
      },
      {
        ...
        description: t({
          en: "A&M Internationals helps organisations navigate the human side of digital transformation — driving adoption, building capability, and embedding new ways of working across all levels of the business.",
          ar: "تساعد A&M Internationals المؤسسات على التعامل مع الجانب البشري للتحول الرقمي — تعزيز التبني وبناء القدرات وترسيخ أساليب عمل جديدة عبر جميع مستويات الأعمال.",
        }),
        tags: [
