...
const impactsDashboardContent = {
  ...
  content: {
    goal: t({ en: "₹1,000,000 Goal", ar: "هدف ١٬٠٠٠٬٠٠٠ روبية" }),
    header: t({ en: "Driving Impact", ar: "قيادة الأثر" }),
    subheader: t({
    ...
    currentAmount: t({ en: "₹420,500", ar: "٤٢٠٬٥٠٠ روبية" }),
    percentage: t({ en: "42%", ar: "٤٢٪" }),
  },
};
