...
const Card: React.FC<CardProps> = ({ title, description, icon }) => {
    return (
        <div className="group relative w-full max-w-[400px] mx-auto lg:max-w-[450px] ">
            {/* MAIN CARD */}
            <div
                className="
        ...
        "
          ...
          "
            ...
            "
                ...
                {/* CONTENT AREA */}
                <div className="relative z-10 p-6 h-full flex flex-col gap-2 mt-12">
                    {/* TITLE */}
                    <h3
                        className="
              text-[24px] font-bold text-[#D4AF37]
              transition-colors duration-300
              group-hover:text-white mt-18
            "
                    >
                        {title}
                    </h3>
                    ...
                    <p
                        className="
              text-[30px] lg:text-[48px] lg:font-semibold text-[#0B132B] max-w-[90%]
              transition-colors duration-300
