...
const faqContent = {
  ...
  content: {
    ...
    faq3Answer: t({
      ...
      ar: "أبسط طريقة هي إرسال رسالة عبر نموذج التواصل أو البريد الإلكتروني am@theaminternational.com. سنُُحدّد مكالمة تعارف خلال يوم عمل واحد لفهم أهدافك وجدولك الزمني وميزانيتك. بعد ذلك، نُقدّم لك عرضًا مُخصّصًا        يشمل النطاق والتسليمات والتسعير — عادةً خلال ٣ إلى ٥ أيام عمل. لا يوجد التزام مُسبق حتى تكون مستعدًا للمضيّ   ّ قدمًا.",
    }),
