...
const Services = () => {
    ...
    return (
        <div id="services" className="flex flex-col items-center justify-center px-4 py-12 md:py-20 lg:py-24">
            {/* ✅ Heading translated */}
