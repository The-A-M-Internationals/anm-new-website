    ...
    const services = [
        {
            ...
            category: content.financeCategory,
            title: content.financeTitle,
            description: content.financeDescription,
            capabilities: [
                content.financeCapability1,
                content.financeCapability2,
                content.financeCapability3,
                content.financeCapability4,
            ],
            metrics: [
                { value: content.financeMetric1Value, label: content.financeMetric1Label },
                { value: content.financeMetric2Value, label: content.financeMetric2Label },
            ],
            tags: [content.financeTag1, content.financeTag2],
        },
        {
            key: "digital",
            path: "/digital-transformation",
            category: content.digitalCategory,
            title: content.digitalTitle,
            description: content.digitalDescription,
            capabilities: [
                content.digitalCapability1,
                content.digitalCapability2,
                content.digitalCapability3,
                content.digitalCapability4,
            ],
            metrics: [
                { value: content.digitalMetric1Value, label: content.digitalMetric1Label },
                { value: content.digitalMetric2Value, label: content.digitalMetric2Label },
            ],
            tags: [content.digitalTag1, content.digitalTag2],
        },
        {
            key: "ai",
            path: "/ai-automations",
            category: content.aiCategory,
            title: content.aiTitle,
            description: content.aiDescription,
            capabilities: [
                content.aiCapability1,
                content.aiCapability2,
                content.aiCapability3,
                content.aiCapability4,
            ],
            metrics: [
                { value: content.aiMetric1Value, label: content.aiMetric1Label },
                { value: content.aiMetric2Value, label: content.aiMetric2Label },
            ],
            tags: [content.aiTag1, content.aiTag2],
        },
    ];
                ...
                <div className="w-[90%] mx-auto">
                    ...
                    <div className="text-center mb-10 md:mb-14">
                        <h3 className="text-black text-2xl sm:text-3xl md:text-4xl lg:text-[48px] font-semibold">
                            {content.heading}{" "}
                            <span className="text-[#D4AF37]">{content.headingHighlight}</span>{" "}
                            {content.headingEnd}
                        </h3>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-6">
                        {services.map((svc, idx) => (
                            <div
                                ...
                                onClick={() => router.push(getLocalizedPath("en", svc.path))}
                            >
                                {/* Animated header */}
                                <div style={{ 
                                ...
                                <div style={{ padding: "9px 18px 13px", display: "flex", alignItems: "center", justifyContent: "space-between", borderTop: "1px solid #F0EAD6" }}>
                                    ...
                                    <div style={{ display: "flex", alignItems: "center", gap: 4, fontSize: 11, fontWeight: 700, color: "#C9A84C" }}>
                                        {content.explore} <span className="am-arr">→</span>
                                    </div>
                                </div>
                            </div>
                        ))}
